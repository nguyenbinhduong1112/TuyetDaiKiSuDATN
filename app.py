...
# FIX LỖI CSS BỊ STREAMLIT XẢ RA MÀN HÌNH (NÉN TOÀN BỘ)
...
# ==========================================
# GIAO DIỆN 1: ĐƠN HÀNG CHUỖI
# ==========================================
if menu_selection == "Đơn hàng chuỗi":
    st.markdown(f"""<div style="display: flex; align-items: center; margin-bottom: 10px; z-index: 2; position: relative;"><h1 style="margin: 0; font-size: 45px; font-weight: 700; color: white;">Hệ thống vận hành tài xế UMBRELLA</h1></div><hr style="margin-top: 5px; border-color: #333; z-index: 2; position: relative;">""", unsafe_allow_html=True)
    ...
    with col_ctrl:
        ...
        try:
            ...
            conn.close()
        except Exception: pending_count = 0
...
# --- TRANG COMING SOON ---
    ...
    st.markdown(f"""<div style="display: flex; align-items: center; margin-bottom: 10px; z-index: 2; position: relative;"><h1 style="margin: 0; font-size: 40px; font-weight: 700; color: white;">Đơn hàng lẻ</h1></div><hr style="margin-top: 5px; border-color: #333; z-index: 2; position: relative;">""", unsafe_allow_html=True)
    ...
    st.markdown(f"""<div style="display: flex; align-items: center; margin-bottom: 10px; z-index: 2; position: relative;"><h1 style="margin: 0; font-size: 40px; font-weight: 700; color: white;">Quản lý thông tin cá nhân</h1></div><hr style="margin-top: 5px; border-color: #333; z-index: 2; position: relative;">""", unsafe_allow_html=True)
    st.info("Trang quản lý hồ sơ và thu nhập của Tài xế đang được thiết kế. Vui lòng quay lại sau!")