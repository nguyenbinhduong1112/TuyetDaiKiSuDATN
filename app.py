...
st.set_page_config(layout="wide", page_title="Tài xế - Umbrella Logistics", page_icon=os.path.join("img", "4D5185D2-0AD7-49AC-B7B2-4E94C13DB13C.png"))
...
# Cập nhật CSS để thêm Icon cho Tab thứ 4 (Giao thông) - ĐÃ ĐỔI VỊ TRÍ ICON 3 VÀ 4
...
if "username" not in st.session_state or st.session_state.username is None: st.session_state.username = "Khách vãng lai"

if "username" not in st.session_state or str(st.session_state.role) != "2":
...
with st.sidebar:
    ...
    # Đã đổi thứ tự Tình trạng giao thông lên trước Quản lý thông tin cá nhân
...
# ===== ĐÃ DI CHUYỂN KHỐI GIAO THÔNG LÊN TRƯỚC THEO YÊU CẦU =====
...
# ===== KHỐI QUẢN LÝ THÔNG TIN ĐÃ ĐƯỢC ĐẨY XUỐNG CUỐI =====
